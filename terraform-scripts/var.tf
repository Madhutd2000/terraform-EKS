...
variable "ebs-iam-role"{
type=string
description = "Amazon EBS CSI driver IAM role"
default=""
}	
...
variable "efs-policy-count"{
type = string
default = "-1"
description = "check efs csi policy exists or not"
}

variable "efs-policy-name"{
type = string
default = "AmazonEKS_EFS_CSI_Driver_Policy"
description = "creates efs-csi policy if not exists"
}	
...
variable "efs-iam-role"{
type=string
description = "Amazon EBS CSI driver IAM role"
}	

variable "efs_sa_name"{
type = string
description = "The k8s service account namespace to allow assume from"
...
# 	type = string
# 	description = "Public  private Amazon container image registry"
